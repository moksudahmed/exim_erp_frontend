...
const API_URL = `${apiUrl}api/v1/expenses`;
...
export const fetchSubsidiaryAccountStatement = async (selectedAccountId, token) => {
  try {
    console.log(selectedAccountId);
    const { data } = await axios.get(`${API_URL}/statements/${selectedAccountId}`, {
      headers: {
